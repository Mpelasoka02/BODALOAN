...
<body>
    ...
    <div class="auth-card">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="role" id="regRole" value="<?php echo e(old('role', 'driver')); ?>">

            <div class="field">
                <label for="name">Full Name</label>
                <div class="field-input">
                    <i class="bi bi-person"></i>
                    <input type="text" name="name" id="name" placeholder="John Mwangi" value="<?php echo e(old('name')); ?>" required autofocus>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="field-input">
                    ...
                    <input type="email" name="email" id="email" placeholder="you@gmail.com" value="<?php echo e(old('email')); ?>" required>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="field-input">
                    ...
                    <input type="text" name="phone" id="phone" placeholder="+255 700 000 000" value="<?php echo e(old('phone')); ?>" required>
                </div>
            </div>
...
<?php /**PATH C:\Users\user\Desktop\BODALOAN2\BODALOAN\resources\views/auth/register.blade.php ENDPATH**/ ?>
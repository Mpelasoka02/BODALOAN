...
<?php $__env->startSection('page-title', auth()->user()->isAdmin() ? 'Admin Reports' : 'Owner Reports'); ?>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card stat-mini gold">
            <div class="card-body">
                ...
                <div class="stat-mini-value">TZS <?php echo e(number_format($totalDisbursed)); ?></div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card stat-mini emerald">
            <div class="card-body">
                ...
                <div class="stat-mini-value" style="color:#059669;">TZS <?php echo e(number_format($totalCollected)); ?></div>
                <?php $collectionRate = $totalDisbursed > 0 ? round(($totalCollected / $totalDisbursed) * 100, 1) : 0; ?>
                <div class="stat-mini-sub"><?php echo e($collectionRate); ?>% collection rate</div>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3">
        <div class="card stat-mini">
            <div class="card-body">
                ...
                <div class="stat-mini-value"><?php echo e($activeLoans); ?></div>
                <div class="stat-mini-sub"><?php echo e($completedLoans); ?> completed</div>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3">
        <div class="card stat-mini danger">
            <div class="card-body">
                ...
                <div class="stat-mini-value" style="color:#ef4444;"><?php echo e($overdueLoans); ?></div>
                <div class="stat-mini-sub"><?php echo e($pendingPayments); ?> pending payments</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card stat-mini purple">
            <div class="card-body">
                ...
                <div class="stat-mini-value" style="color:#7c3aed;"><?php echo e($usersByRole->sum()); ?></div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card stat-mini">
            <div class="card-body">
                ...
                <div class="stat-mini-value"><?php echo e($registeredMotorcycles); ?></div>
    ...
    <div class="col-sm-6 col-lg-4">
        <div class="card stat-mini gold">
            <div class="card-body">
                ...
                <div class="stat-mini-value">TZS <?php echo e(number_format($outstandingBalance ?? 0)); ?></div>
    ...
    <div class="col-sm-6 col-lg-4">
        <div class="card stat-mini emerald">
            <div class="card-body">
                ...
                <div class="stat-mini-value" style="color:#059669;">TZS <?php echo e(number_format($weeklyCollections ?? 0)); ?></div>
...
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <span class="badge-status verified" style="font-size:0.7rem;">TZS <?php echo e(number_format($totalCollected)); ?> total</span>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header">
        <strong style="color:var(--text);font-size:0.9rem;"><?php echo e(auth()->user()->isAdmin() ? 'Motorcycles by Status' : 'My Motorcycles by Status'); ?></strong>
    </div>
    <div class="card-body">
        <div class="chart-container" style="height:220px;">
...
<?php if(isset($monthlyCollections) && $monthlyCollections->count()): ?>
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        <strong style="color:var(--text);font-size:0.9rem;">Monthly Collections Detail</strong>
        <span class="badge-status active" style="font-size:0.7rem;"><?php echo e($monthlyCollections->count()); ?> months</span>
    </div>
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            ...
            <tbody>
                <?php $__currentLoopData = $monthlyCollections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="fw-semibold" style="color:var(--text);"><?php echo e(is_array($mc) ? ($mc['month'] ?? '-') : ($mc->month ?? '-')); ?></td>
                        <td class="fw-semibold" style="color:var(--emerald-600);">TZS <?php echo e(number_format(is_array($mc) ? $mc['total'] : $mc->total)); ?></td>
                        <td><?php echo e(is_array($mc) ? ($mc['count'] ?? 0) : ($mc->count ?? 0)); ?></td>
                    </tr>
...
<?php if(isset($defaulters) && $defaulters->count()): ?>
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        <strong style="color:var(--text);font-size:0.9rem;">Overdue Loans</strong>
        <span class="badge-status rejected" style="font-size:0.7rem;"><?php echo e($defaulters->count()); ?> overdue</span>
    </div>
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            <thead>
            ...
            <tbody>
                <?php $__currentLoopData = $defaulters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $def): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="fw-semibold" style="color:var(--text);"><?php echo e($def->driver->name ?? '-'); ?></td>
                        <td><?php echo e($def->motorcycle->plate_number ?? '-'); ?></td>
                        <td class="fw-semibold" style="color:#ef4444;">TZS <?php echo e(number_format($def->balance)); ?></td>
...
<?php if(auth()->user()->isAdmin() && isset($ownerPerformance) && $ownerPerformance->count()): ?>
<div class="card mb-4">
    <div class="card-header">
    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            ...
            <tbody>
                <?php $__currentLoopData = $ownerPerformance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="fw-semibold" style="color:var(--text);"><?php echo e($owner->name); ?></td>
                        <td><?php echo e($owner->total_loans_count); ?></td>
                        <td><span class="badge-status active"><?php echo e($owner->active_loans_count); ?></span></td>
                        <td><span class="badge-status verified"><?php echo e($owner->completed_loans_count); ?></span></td>
                        <td class="fw-semibold" style="color:var(--emerald-600);">TZS <?php echo e(number_format($owner->total_revenue)); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        </table>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (revenueCtx) {
        const revenueData = <?php echo json_encode($monthlyCollections ?? collect(), 15, 512) ?>;
    ...
    if (loanCtx) {
        const loanData = <?php echo json_encode($loansByStatus ?? collect(), 15, 512) ?>;
    ...
    if (usersCtx) {
        const usersData = <?php echo json_encode($usersByRole ?? collect(), 15, 512) ?>;
    ...
    if (motoCtx) {
        const motoData = <?php echo json_encode($motorcyclesByStatus ?? collect(), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\BODALOAN2\BODALOAN\resources\views/reports/index.blade.php ENDPATH**/ ?>
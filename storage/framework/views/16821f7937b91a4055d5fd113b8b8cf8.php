...
<nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb" style="background:none;padding:0;margin:0;font-size:0.82rem;">
        <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>" style="color:var(--text-muted);text-decoration:none;">Dashboard</a></li>
        <li class="breadcrumb-item active" style="color:var(--text-primary);">Profile Settings</li>
    </ol>
</nav>

<?php if($user->needsProfileSetup() && !$user->isAdmin()): ?>
        ...
        <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="nida" class="form-control" value="<?php echo e(old('nida', $user->nida)); ?>" placeholder="National ID number">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="birthdate" class="form-control" value="<?php echo e(old('birthdate', $user->birthdate ? $user->birthdate->format('Y-m-d') : '')); ?>">
                </div>
                <?php if($user->isOwner()): ?>
                <div class="col-12">
                    ...
                    <div class="d-flex gap-2 align-items-center mb-2">
                        ...
                        <?php if($user->latitude && $user->longitude): ?>
                            <a href="https://www.google.com/maps?q=<?php echo e($user->latitude); ?>,<?php echo e($user->longitude); ?>" target="_blank" class="btn btn-outline btn-sm" style="white-space:nowrap;">
                    ...
                    <div class="row g-2">
                        <div class="col-md-4">
                            <input type="number" step="any" name="latitude" class="form-control" value="<?php echo e(old('latitude', $user->latitude)); ?>" placeholder="Latitude">
                        </div>
                        <div class="col-md-4">
                            <input type="number" step="any" name="longitude" class="form-control" value="<?php echo e(old('longitude', $user->longitude)); ?>" placeholder="Longitude">
                        </div>
                        <div class="col-md-4">
                            <input type="text" name="location_name" class="form-control" value="<?php echo e(old('location_name', $user->location_name)); ?>" placeholder="Location name (e.g. Kariakoo)">
                        </div>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="row g-3 mt-2">
                <div class="col-md-6">
                    ...
                    <?php if($user->profile_photo_url): ?>
                        <div class="mt-2"><img src="<?php echo e($user->profile_photo_url); ?>" style="width:80px;height:80px;object-fit:cover;border-radius:50%;border:2px solid var(--border);"></div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
                    ...
                    <?php if($user->id_photo_url): ?>
                        <div class="mt-2"><img src="<?php echo e($user->id_photo_url); ?>" style="width:120px;height:auto;max-height:80px;object-fit:cover;border:2px solid var(--border);border-radius:4px;"></div>
                    <?php endif; ?>
                </div>
            </div>
            <div class="mt-4">
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\BODALOAN2\BODALOAN\resources\views/profile/edit.blade.php ENDPATH**/ ?>
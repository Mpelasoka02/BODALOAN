...
<head>
    ...
    <title><?php echo e($motorcycle->make); ?> <?php echo e($motorcycle->model); ?> — BodaLink</title>
...
<nav class="nav">
    ...
    <div class="nav-center">
        ...
        <a href="<?php echo e(url('/')); ?>#browse">Browse</a>
    </div>
...
<div class="hero-img">
    <?php if($motorcycle->photo): ?>
        <img src="<?php echo e(asset('storage/' . $motorcycle->photo)); ?>" alt="<?php echo e($motorcycle->make); ?> <?php echo e($motorcycle->model); ?>">
    <?php else: ?>
    ...
    <div class="hero-img-back">
        <a href="<?php echo e(route('home')); ?>"><i class="bi bi-arrow-left"></i> Back to Marketplace</a>
    </div>
    <div class="hero-img-overlay">
        <div>
            <div class="hero-img-title"><?php echo e($motorcycle->make); ?> <?php echo e($motorcycle->model); ?></div>
            <div class="hero-img-sub"><?php echo e($motorcycle->plate_number); ?> &middot; <?php echo e($motorcycle->color); ?> &middot; <?php echo e($motorcycle->year); ?></div>
        </div>
        ...
        <div class="detail-main">
            <div class="detail-section">
                ...
                <div class="specs-grid">
                    <div class="spec-tile">
                        ...
                        <div><div class="spec-val"><?php echo e($motorcycle->engine_cc); ?>cc</div><div class="spec-lbl">Engine Capacity</div></div>
                    </div>
                    <div class="spec-tile">
                        <div class="spec-icon green"><i class="bi bi-calendar-week"></i></div>
                        <div><div class="spec-val"><?php echo e($motorcycle->loan_duration_weeks); ?> weeks</div><div class="spec-lbl">Loan Duration</div></div>
                    </div>
                    <div class="spec-tile">
                        <div class="spec-icon orange"><i class="bi bi-cash"></i></div>
                        <div><div class="spec-val">TZS <?php echo e($motorcycle->weekly_amount ? number_format($motorcycle->weekly_amount) : '—'); ?></div><div class="spec-lbl">Weekly Payment</div></div>
                    </div>
                    <div class="spec-tile">
                        <div class="spec-icon purple"><i class="bi bi-palette"></i></div>
                        <div><div class="spec-val"><?php echo e($motorcycle->color); ?></div><div class="spec-lbl">Color</div></div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-section">
                ...
                <div class="detail-desc">
                    This <?php echo e($motorcycle->year); ?> <strong><?php echo e($motorcycle->make); ?> <?php echo e($motorcycle->model); ?></strong> (<?php echo e($motorcycle->color); ?>) is available for hire-purchase through BodaLink.
                    Pay <strong>TZS <?php echo e($motorcycle->weekly_amount ? number_format($motorcycle->weekly_amount) : '—'); ?></strong> per week for
                    <strong><?php echo e($motorcycle->loan_duration_weeks); ?> weeks</strong> and own the motorcycle.
                    The total loan amount is <strong>TZS <?php echo e(number_format($motorcycle->loan_amount)); ?></strong>.
                    All payments are tracked on the platform — cash, M-Pesa, or bank transfer accepted.
                </div>
            </div>

            <?php if($motorcycle->owner): ?>
            <div class="detail-section">
                <div class="detail-section-title"><i class="bi bi-person"></i> Listed By</div>
                <div class="owner-card">
                    <div class="owner-avatar"><?php echo e(strtoupper(substr($motorcycle->owner->name, 0, 1))); ?></div>
                    <div>
                        <div class="owner-name"><?php echo e($motorcycle->owner->name); ?></div>
                        <?php if($motorcycle->owner->phone): ?>
                            <div style="font-size:0.82rem;color:var(--text-secondary);margin-top:2px;"><i class="bi bi-telephone me-1"></i><?php echo e($motorcycle->owner->phone); ?></div>
                        <?php endif; ?>
        ...
        <div class="detail-sidebar">
            <div class="price-card">
                <div class="price-tag">
                    ...
                    <div class="price">TZS <?php echo e(number_format($motorcycle->loan_amount)); ?></div>
                    <div class="sub"><?php echo e($motorcycle->loan_duration_weeks); ?> weeks &middot; TZS <?php echo e($motorcycle->weekly_amount ? number_format($motorcycle->weekly_amount) : '—'); ?>/week</div>
                </div>
                <div class="price-breakdown">
                    <div class="price-row"><span class="lbl">Weekly Payment</span><span class="val">TZS <?php echo e($motorcycle->weekly_amount ? number_format($motorcycle->weekly_amount) : '—'); ?></span></div>
                    <div class="price-row"><span class="lbl">Duration</span><span class="val"><?php echo e($motorcycle->loan_duration_weeks); ?> weeks</span></div>
                    <div class="price-row"><span class="lbl">Engine</span><span class="val"><?php echo e($motorcycle->engine_cc); ?>cc</span></div>
                    <div class="price-row total"><span class="lbl">Total Loan</span><span class="val">TZS <?php echo e(number_format($motorcycle->loan_amount)); ?></span></div>
                </div>
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->isDriver()): ?>
                        <a href="<?php echo e(route('marketplace.apply', $motorcycle)); ?>" class="btn-apply primary"><i class="bi bi-hand-index-thumb"></i> Apply Now</a>
                    <?php endif; ?>
                    <?php if($motorcycle->owner && auth()->id() !== $motorcycle->owner_id): ?>
                        <a href="<?php echo e(route('chat.start.direct', $motorcycle->owner_id)); ?>" class="btn-apply outline"><i class="bi bi-chat-dots"></i> Chat with Owner</a>
                    <?php endif; ?>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="btn-apply primary"><i class="bi bi-box-arrow-in-right"></i> Login to Apply</a>
                <?php endif; ?>
                <a href="<?php echo e(route('home')); ?>" class="btn-apply outline"><i class="bi bi-search"></i> Browse More Motorcycles</a>
            </div>
...
<section class="cta">
    <?php if(auth()->guard()->check()): ?>
        ...
        <div class="cta-btns">
            <a href="<?php echo e(route('marketplace.apply', $motorcycle)); ?>" class="btn-white"><i class="bi bi-hand-index-thumb"></i> Apply Now</a>
            <a href="<?php echo e(route('home')); ?>" class="btn-outline-w"><i class="bi bi-search"></i> Browse More</a>
        </div>
    <?php else: ?>
        <h2>Ready to Start Earning?</h2>
        <p>Create a free account and apply for your boda-boda today. It only takes a few minutes.</p>
        <div class="cta-btns">
            <a href="<?php echo e(route('register')); ?>" class="btn-white"><i class="bi bi-person-plus"></i> Register</a>
            <a href="<?php echo e(route('login')); ?>" class="btn-outline-w"><i class="bi bi-box-arrow-in-right"></i> Login</a>
        </div>
    <?php endif; ?>
</section>
...
<footer class="footer">
    <div class="footer-grid">
        ...
        <div class="footer-col">
            ...
            <a href="<?php echo e(url('/')); ?>#how">How It Works</a>
            <a href="<?php echo e(url('/')); ?>#services">Services</a>
            <a href="<?php echo e(url('/')); ?>#browse">Browse Motorcycles</a>
        </div>
        <div class="footer-col">
            <h4>Account</h4>
            <?php if(auth()->guard()->check()): ?>
        ...
        <div class="footer-col">
            <h4>Support</h4>
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('chat.start.direct', \App\Models\User::where('role','admin')->first()?->id ?? 1)); ?>">Help Center</a>
                <a href="<?php echo e(route('chat.start.direct', \App\Models\User::where('role','admin')->first()?->id ?? 1)); ?>">Contact Us</a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>">Help Center</a>
                <a href="<?php echo e(route('login')); ?>">Contact Us</a>
            <?php endif; ?>
            <a href="<?php echo e(url('/#how')); ?>">How It Works</a>
            <a href="<?php echo e(url('/#services')); ?>">Services</a>
        </div>
    ...
    <div class="footer-bottom">
        <div>&copy; <?php echo e(date('Y')); ?> BodaLink. All rights reserved.</div>
...
<?php /**PATH C:\Users\user\Desktop\BODALOAN2\BODALOAN\resources\views/marketplace/show.blade.php ENDPATH**/ ?>
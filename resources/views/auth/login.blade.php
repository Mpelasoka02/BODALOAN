...
<body>
    ...
    <div class="auth-card">
        ...
        @php $prevRole = old('login_role', 'owner'); @endphp

        <div class="role-tabs" id="roleTabs" style="{{ $prevRole === 'admin' ? 'display:none' : '' }}">
            <button type="button" class="role-tab {{ $prevRole !== 'driver' ? 'active' : '' }}" data-role="owner" onclick="switchTab(this)">
                <i class="bi bi-building me-1"></i> Owner
            </button>
            <button type="button" class="role-tab {{ $prevRole === 'driver' ? 'active' : '' }}" data-role="driver" onclick="switchTab(this)">
        ...
        <form method="POST" action="{{ route('login') }}">
            @csrf
            <input type="hidden" name="login_role" id="loginRole" value="{{ old('login_role', 'owner') }}">

            <div class="field">
                <label for="email">Email</label>
                <div class="field-input">
                    <i class="bi bi-envelope"></i>
                    <input type="email" name="email" id="email" placeholder="you@gmail.com" value="{{ old('email') }}" required autofocus>
                </div>
            </div>

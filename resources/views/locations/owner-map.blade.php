...
@section('title', 'My Fleet GPS — BodaLink')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1 fw-bold"><i class="bi bi-geo-alt-fill text-warning"></i> My Fleet GPS</h4>
        <p class="text-muted mb-0 small">Track your bodabodas and their drivers</p>
    </div>
...
<div class="card border-0 shadow-sm text-center py-5">
    ...
    <p class="text-muted">None of your bodabodas have GPS data yet.</p>
</div>
@endif
@endsection

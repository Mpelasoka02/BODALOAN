    ...
    <nav class="nav">
        <div class="container">
            ...
            <div class="nav-actions">
                ...
                <a href="{{ route('register') }}" class="btn-navy">Register</a>
            </div>
        </div>
    </nav>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-inner">
                ...
                <div class="hero-btns">
                    <a href="{{ route('register') }}" class="btn-primary"><i class="bi bi-person-plus"></i> Register Now</a>
                    <a href="{{ route('login') }}" class="btn-outline"><i class="bi bi-box-arrow-in-right"></i> Login</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="showcase">
                <div class="showcase-content">
                    ...
                    <a href="{{ route('register') }}" class="btn-primary"><i class="bi bi-bicycle"></i> Register as Driver</a>
                </div>
        ...
        <div class="container">
            <div class="showcase showcase-alt">
                <div class="showcase-content">
                    ...
                    <a href="{{ route('register') }}" class="btn-primary"><i class="bi bi-building"></i> Register as Owner</a>
                </div>
                <div class="showcase-visual">
                    <div class="sv-card">
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <span>&copy; {{ date('Y') }} BodaLink. All rights reserved.</span>

@extends('layouts.app')
@section('title', 'Edit Bodaboda')
@section('page-title', 'Edit Bodaboda')
...
<nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb" style="background:none;padding:0;margin:0;font-size:0.82rem;">
        ...
        <li class="breadcrumb-item"><a href="{{ route('owner.vehicles') }}" style="color:var(--text-secondary);text-decoration:none;">My Bodabodas</a></li>
        <li class="breadcrumb-item active" style="color:var(--text);">{{ $motorcycle->plate_number }}</li>
    </ol>
</nav>

<div class="card" style="padding:24px;">
    <form method="POST" action="{{ route('owner.vehicles.update', $motorcycle) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div style="background:var(--page-bg);border-radius:12px;padding:20px;margin-bottom:20px;">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="plate_number" class="form-control" value="{{ old('plate_number', $motorcycle->plate_number) }}" required>
                </div>
                <div class="col-md-6 mb-3">
        ...
        <div style="background:var(--page-bg);border-radius:12px;padding:20px;margin-bottom:20px;">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="gps_device_id" class="form-control" value="{{ old('gps_device_id', $motorcycle->gps_device_id) }}">
                </div>
            </div>
        </div>
        ...
        <div style="background:var(--page-bg);border-radius:12px;padding:20px;margin-bottom:20px;">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="location_name" id="locationName" class="form-control" placeholder="e.g. Kariakoo Market, Dar es Salaam" value="{{ old('location_name', $motorcycle->location_name) }}">
                </div>
                <div class="col-md-6 mb-3">
                ...
                <input type="hidden" name="latitude" id="latitude" value="{{ old('latitude', $motorcycle->latitude) }}">
                <input type="hidden" name="longitude" id="longitude" value="{{ old('longitude', $motorcycle->longitude) }}">
                <div class="col-12">
                ...
                @if($motorcycle->latitude && $motorcycle->longitude)
                    <div class="col-12 mt-2">
                        <a href="https://www.google.com/maps?q={{ $motorcycle->latitude }},{{ $motorcycle->longitude }}" target="_blank" style="color:var(--navy-700);font-size:0.82rem;font-weight:600;text-decoration:none;"><i class="bi bi-box-arrow-up-right me-1"></i> View current location on Google Maps</a>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div style="background:var(--page-bg);border-radius:12px;padding:20px;margin-bottom:20px;">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="loan_amount" class="form-control" value="{{ old('loan_amount', $motorcycle->loan_amount) }}" min="0" required>
                </div>
                <div class="col-md-4 mb-3">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="loan_duration_weeks" class="form-control" value="{{ old('loan_duration_weeks', $motorcycle->loan_duration_weeks) }}" min="1" required>
                </div>
            </div>
        </div>
        ...
        <div style="background:var(--page-bg);border-radius:12px;padding:20px;margin-bottom:20px;">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    @if($motorcycle->photo)
                        <small style="color:var(--text-muted);font-size:0.72rem;">Current: {{ basename($motorcycle->photo) }}</small>
                    @endif
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    @if($motorcycle->registration_card)
                        <small style="color:var(--text-muted);font-size:0.72rem;">Current: {{ basename($motorcycle->registration_card) }}</small>
                    @endif
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    @if($motorcycle->insurance)
                        <small style="color:var(--text-muted);font-size:0.72rem;">Current: {{ basename($motorcycle->insurance) }}</small>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('owner.vehicles.show', $motorcycle) }}" class="btn btn-outline"><i class="bi bi-x-lg me-1"></i>Cancel</a>
        </div>
    </form>
</div>

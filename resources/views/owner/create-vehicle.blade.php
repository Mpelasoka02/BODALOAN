@extends('layouts.app')
@section('title', 'Add Bodaboda')
@section('page-title', 'Register a New Bodaboda')
...
@if ($errors->any())
    <div style="background:#fef2f2;border:1px solid #fca5a5;border-radius:10px;padding:14px 18px;margin-bottom:20px;">
        ...
        @foreach ($errors->all() as $error)
            <div style="color:#991b1b;font-size:0.82rem;padding:2px 0;">{{ $error }}</div>
        @endforeach
    </div>
@endif

<div class="card" style="padding:24px;">
    <form method="POST" action="{{ route('owner.vehicles.store') }}" enctype="multipart/form-data" id="createForm">
        @csrf
        ...
        <div style="background:var(--page-bg);border-radius:12px;padding:20px;margin-bottom:20px;">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="make" class="form-control" placeholder="e.g. TVS HLX 125" value="{{ old('make') }}" required>
                </div>
                <div class="col-md-6 mb-3">
        ...
        <div style="background:var(--page-bg);border-radius:12px;padding:20px;margin-bottom:20px;">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="location_name" id="locationName" class="form-control" placeholder="e.g. Kariakoo Market, Dar es Salaam" value="{{ old('location_name') }}" required>
                </div>
                <div class="col-md-6 mb-3">
        ...
        <div style="background:var(--page-bg);border-radius:12px;padding:20px;margin-bottom:20px;">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="loan_amount" id="loanAmount" class="form-control" placeholder="e.g. 2400000" value="{{ old('loan_amount') }}" min="0" required oninput="calcWeeks()">
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="weekly_amount" id="weeklyAmount" class="form-control" placeholder="e.g. 46000" value="{{ old('weekly_amount') }}" min="1" required oninput="calcWeeks()">
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    <input type="hidden" name="loan_duration_weeks" id="loanDurationWeeks" value="{{ old('loan_duration_weeks') }}">
                </div>
            </div>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('owner.vehicles') }}" class="btn btn-outline"><i class="bi bi-x-lg me-1"></i>Cancel</a>
        </div>
    </form>
</div>
